...
var (
	...
	ignoreMethodsNotIn122 = map[string]bool{
		...
		"DeleteWorkerDeployment":                true,
		"DeleteWorkerDeploymentVersion":         true,
		"DescribeDeployment":                    true,
		"DescribeWorkerDeployment":              true,
		"DescribeWorkerDeploymentVersion":       true,
		...
		"SetWorkerDeploymentCurrentVersion":     true,
		"SetWorkerDeploymentRampingVersion":     true,
		"ShutdownWorker":                        true,
		"UnpauseActivity":                       true,
		"UnpauseActivityById":                   true,
		"UpdateActivityOptions":                 true,
		"UpdateActivityOptionsById":             true,
		"UpdateWorkerDeploymentVersionMetadata": true,
