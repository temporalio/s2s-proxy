...
type (
	TranslatorInterceptor struct {
		logger      log.Logger
		translators []Translator
	}
)

func NewTranslatorInterceptor(
	logger log.Logger,
	translators []Translator,
) *TranslatorInterceptor {
	return &TranslatorInterceptor{
		logger:      logger,
		translators: translators,
	}
}

var _ grpc.UnaryServerInterceptor = (*TranslatorInterceptor)(nil).Intercept
var _ grpc.StreamServerInterceptor = (*TranslatorInterceptor)(nil).InterceptStream

func (i *TranslatorInterceptor) Intercept(
	ctx context.Context,
	req any,
...
func (i *TranslatorInterceptor) InterceptStream(
	srv any,
